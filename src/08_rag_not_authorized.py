...
# Take-away:
# - Amazon Kendra can filter out search results if the requestor is not authorized to access the source.

# Question: Could we do document-level access control if we fine-tuned our model with our data?